...
class VentastiemposImport implements ToCollection, WithHeadingRow
{
    /**
    ...
    {
        foreach ($rows as $row) {
            // Verificar si 'codigo_venta' tiene un valor
            if (empty($row['codigo_venta'])) {
                continue; // Salta esta fila si no tiene valor 'codigo_venta'
            }
