                        ...
                        @foreach ($productos as $item)
                            <tr>
                                ...
                                <td class="text-xxs mb-0 text-center align-middle">
                                    <a href="{{ route('elaboracionproductos.show', $item->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-eye"></i></a>
                                </td>
                                <td class="text-xxs mb-0 text-center align-middle">
                                    <a href="{{ route('elaboracionproductos.create', $item->id) }}" class="btn btn-info btn-sm"><i class="fas fa-plus"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
